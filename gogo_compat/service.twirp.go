...
func (c *svcProtobufClient) Send(ctx context.Context, in *Msg) (*Msg, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirptest.gogo_compat")
...
const SvcPathPrefix = "/twirp/twirptest.gogo_compat.Svc/"
...
func (s *svcServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirptest.gogo_compat.Svc/Send":
...
var twirpFileDescriptor0 = []byte{
	...
	0x0a, 0x8f, 0x9c, 0x13, 0x6f, 0x14, 0x37, 0x92, 0x50, 0x12, 0x1b, 0xd8, 0x6a, 0x63, 0x40, 0x00,
	0x00, 0x00, 0xff, 0xff, 0x30, 0x23, 0x60, 0x44, 0x8b, 0x00, 0x00, 0x00,
}
