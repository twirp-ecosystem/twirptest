...
func (c *svcProtobufClient) Method(ctx context.Context, in *Msg) (*Msg, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirptest.source_relative")
...
const SvcPathPrefix = "/twirp/twirptest.source_relative.Svc/"
...
func (s *svcServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirptest.source_relative.Svc/Method":
