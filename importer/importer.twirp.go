...
import twirptest_importable "github.com/iheanyi/twirptest/importable"
...
type Svc2 interface {
	Send(context.Context, *twirptest_importable.Msg) (*twirptest_importable.Msg, error)
}
...
func (c *svc2ProtobufClient) Send(ctx context.Context, in *twirptest_importable.Msg) (*twirptest_importable.Msg, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirptest.importer")
	ctx = ctxsetters.WithServiceName(ctx, "Svc2")
	ctx = ctxsetters.WithMethodName(ctx, "Send")
	out := new(twirptest_importable.Msg)
...
func (c *svc2JSONClient) Send(ctx context.Context, in *twirptest_importable.Msg) (*twirptest_importable.Msg, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirptest.importer")
	ctx = ctxsetters.WithServiceName(ctx, "Svc2")
	ctx = ctxsetters.WithMethodName(ctx, "Send")
	out := new(twirptest_importable.Msg)
...
const Svc2PathPrefix = "/twirp/twirptest.importer.Svc2/"
...
func (s *svc2Server) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirptest.importer.Svc2/Send":
...
func (s *svc2Server) serveSendJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	reqContent := new(twirptest_importable.Msg)
	...
	// Call service method
	var respContent *twirptest_importable.Msg
	func() {
		defer func() {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *twirptest_importable.Msg and nil error while calling Send. nil responses are not supported"))
		return
	}
