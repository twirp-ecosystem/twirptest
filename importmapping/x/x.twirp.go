...
import twirptest_importmapping_y "github.com/twitchtv/twirp/twirptest/importmapping/y"
...
type Svc1 interface {
	Send(context.Context, *twirptest_importmapping_y.MsgY) (*twirptest_importmapping_y.MsgY, error)
}
...
func (c *svc1ProtobufClient) Send(ctx context.Context, in *twirptest_importmapping_y.MsgY) (*twirptest_importmapping_y.MsgY, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirptest.importmapping.x")
	ctx = ctxsetters.WithServiceName(ctx, "Svc1")
	ctx = ctxsetters.WithMethodName(ctx, "Send")
	out := new(twirptest_importmapping_y.MsgY)
...
func (c *svc1JSONClient) Send(ctx context.Context, in *twirptest_importmapping_y.MsgY) (*twirptest_importmapping_y.MsgY, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirptest.importmapping.x")
	ctx = ctxsetters.WithServiceName(ctx, "Svc1")
	ctx = ctxsetters.WithMethodName(ctx, "Send")
	out := new(twirptest_importmapping_y.MsgY)
...
const Svc1PathPrefix = "/twirp/twirptest.importmapping.x.Svc1/"
...
func (s *svc1Server) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirptest.importmapping.x.Svc1/Send":
...
func (s *svc1Server) serveSendJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	reqContent := new(twirptest_importmapping_y.MsgY)
	...
	// Call service method
	var respContent *twirptest_importmapping_y.MsgY
	func() {
		defer func() {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *twirptest_importmapping_y.MsgY and nil error while calling Send. nil responses are not supported"))
		return
	}
